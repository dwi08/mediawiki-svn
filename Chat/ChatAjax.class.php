...
class ChatAjax {
	...
	static public function getUserInfo(){
		...
		if(empty($data)) {
			wfDebug($wgRequest->getVal('key') . " not found in memcache\n**************************************************************************************************\n");
		...
		$retVal = array(
			'canChat' => true,//Chat::canChat($user),
			...
			'avatarSrc' => 'https://img.skitch.com/20110731-d2enutmtn1b89t85n1y3fpc1f8.jpg', //AvatarService::getAvatarUrl($user->getName(), self::CHAT_AVATAR_DIMENSION),
			'editCount' => "",
			'since' => '',
