/* remtoteIframe extension for wikiEditor */

( function( $ ) { $.wikiEditor.extensions.remoteIframe = function( context ) {
...
context.evt = $.extend( context.evt, {
	...
	'change': function( event ) {
		// triggered when any change has occurred
		/*
...
context.fn = $.extend( context.fn, {
	'highlightLine': function( $element, mode ) {
		// this is used by templateEditor & toc
		/*
		if ( !$element.is( 'p' ) ) {
	...
	'rawTraverser': function( node, inP, ancestor, skipNoinclude ) {
		// used by highlight, and internally by various functions in wikiEditor
		/*
		this.node = node;
		this.inP = inP;
	...
	'purgeOffsets': function() {
		// used by highlight, templateEditor
...
/*
		...
		*/
		// TODO add edit warning (steal it from UploadWizard...)
	},
